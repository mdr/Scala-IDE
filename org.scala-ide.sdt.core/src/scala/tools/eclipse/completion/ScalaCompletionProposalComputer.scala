...
class ScalaCompletionProposalComputer extends IJavaCompletionProposalComputer {
  ...
  private def findCompletions(position: Int, context: ContentAssistInvocationContext, scu: ScalaCompilationUnit)(sourceFile: SourceFile, compiler: ScalaPresentationCompiler): java.util.List[_] = {

...
class ErrorRefactoringWizard(msg: String = "Error, not a text editor.") extends RefactoringWizard(new FailingRefactoring(msg), RefactoringWizard.WIZARD_BASED_USER_INTERFACE) {
